...
public class Programm {
    ...
    public static void main(String[] args) {
        ...
        Mitarbeiter mitarbeiter = new Mitarbeiter("Holger", "Geldfuchs", adresseMitarbeiter);
        ...
        if (girokonto1.uberweisung(2000, girokonto2)) {
            System.out.println(girokonto2);
            System.out.println(girokonto1);
        } else {
        ...
        if (girokonto1.uberweisung(100.0, girokonto2)) {
            System.out.println(girokonto1);
        } else {
            System.out.println("Fehler beim Überweisen");
        }
